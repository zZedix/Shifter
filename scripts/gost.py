...
from .config import repository_url, GOST_SERVICE_PATH, GOST_INSTALL_DIR
...
def install_gost(domain, port):
    ...
    try:
        ...
        print("Downloading and configuring gost.service file...")
        service_url = f"{repository_url}/config/gost.service"
